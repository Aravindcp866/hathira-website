...
const ContextMenu = (props) => {
  ...
  const {
    field,
    parent
  } = t1, title = field?.title || field?.name || "Unknown type", [items, setItems] = react.useState(void 0);
  let t2, t3;
  ...
  }, t3 = [field, node, parent, getDocument], $[3] = field, $[4] = getDocument, $[5] = node, $[6] = parent, $[7] = t2, $[8] = t3) : (t2 = $[7], t3 = $[8]), react.useEffect(t2, t3);
  let t4;
  $[9] !== x || $[10] !== y ? (t4 = {
  ...
  let t5;
  $[12] !== field ? (t5 = PointerEvents.getNodeIcon(field), $[12] = field, $[13] = t5) : t5 = $[13];
  const icon = t5;
  let t6;
  ...
  let t7;
  $[15] !== icon || $[16] !== items ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Box, { flex: "none", children: items ? /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Text, { size: 1, children: icon }) : /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Spinner, { size: 1 }) }), $[15] = icon, $[16] = items, $[17] = t7) : t7 = $[17];
  const t8 = items ? title : "Loading...";
  let t9;
  $[18] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Stack, { flex: 1, space: 2, children: /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Text, { size: 1, weight: "semibold", children: t8 }) }), $[18] = t8, $[19] = t9) : t9 = $[19];
  let t10;
  $[20] !== t7 || $[21] !== t9 ? (t10 = /* @__PURE__ */ jsxRuntime.jsxs(_visualEditing.Flex, { gap: 2, padding: 2, children: [
    t7,
    t9
  ] }), $[20] = t7, $[21] = t9, $[22] = t10) : t10 = $[22];
  let t11;
  $[23] !== boundaryElement || $[24] !== items || $[25] !== onDismiss ? (t11 = items && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
  ...
  let t12;
  $[27] !== t10 || $[28] !== t11 ? (t12 = /* @__PURE__ */ jsxRuntime.jsxs(_visualEditing.Menu, { style: t6, children: [
    t10,
    t11
  ...
  let t15;
  $[33] !== t13 || $[34] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx("div", { style: t14 }, t13), $[33] = t13, $[34] = t14, $[35] = t15) : t15 = $[35];
  let t16;
  $[36] !== contextMenuReferenceElement || $[37] !== t12 || $[38] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Popover, { __unstable_margins: POPOVER_MARGINS, arrow: !1, open: !0, placement: "right-start", referenceElement: contextMenuReferenceElement, content: t12, children: t15 }), $[36] = contextMenuReferenceElement, $[37] = t12, $[38] = t15, $[39] = t16) : t16 = $[39];
  let t17;
  return $[40] !== onDismiss || $[41] !== t16 ? (t17 = /* @__PURE__ */ jsxRuntime.jsx(PointerEvents.PopoverPortal, { setBoundaryElement, onDismiss, children: t16 }), $[40] = onDismiss, $[41] = t16, $[42] = t17) : t17 = $[42], t17;
};
...
function createIntentLink(node) {
  const {
    ...
    workspace,
    perspective
  } = node, [url, search] = csm.createEditUrl({
    baseUrl,
    workspace,
    tool,
    type,
...
const ElementOverlayInner = (props) => {
  ...
  let t7;
  $[25] !== schemaType ? (t7 = schemaType?.icon ? /* @__PURE__ */ jsxRuntime.jsx("div", { dangerouslySetInnerHTML: {
    __html: schemaType.icon
  } }) : /* @__PURE__ */ jsxRuntime.jsx(icons.DocumentIcon, {}), $[25] = schemaType, $[26] = t7) : t7 = $[26];
  const icon = t7, menuId = react.useId();
  let t8;
  ...
  let t10;
  $[31] !== href || $[32] !== showActions ? (t10 = showActions ? /* @__PURE__ */ jsxRuntime.jsx(Actions, { gap: 1, paddingY: 1, children: /* @__PURE__ */ jsxRuntime.jsx(Link, { href }) }) : null, $[31] = href, $[32] = showActions, $[33] = t10) : t10 = $[33];
  let t11;
  $[34] !== comlink2 || $[35] !== draggable || $[36] !== handleLabelClick || $[37] !== icon || $[38] !== menuId || $[39] !== nodePluginCollections || $[40] !== onActivateExclusivePlugin || $[41] !== onMenuOpenChange || $[42] !== showMenu || $[43] !== title ? (t11 = (title || showMenu) && /* @__PURE__ */ jsxRuntime.jsx(Tab, { gap: 1, paddingY: 1, onClick: handleLabelClick, children: /* @__PURE__ */ jsxRuntime.jsxs(Labels, { gap: 2, padding: 2, children: [
  ...
  ] }) }), $[34] = comlink2, $[35] = draggable, $[36] = handleLabelClick, $[37] = icon, $[38] = menuId, $[39] = nodePluginCollections, $[40] = onActivateExclusivePlugin, $[41] = onMenuOpenChange, $[42] = showMenu, $[43] = title, $[44] = t11) : t11 = $[44];
  let t12;
  $[45] !== nodePluginCollections ? (t12 = nodePluginCollections?.map(_temp4$1), $[45] = nodePluginCollections, $[46] = t12) : t12 = $[46];
  let t13;
  $[47] !== t12 ? (t13 = /* @__PURE__ */ jsxRuntime.jsx(HUD, { children: t12 }), $[47] = t12, $[48] = t13) : t13 = $[48];
  let t14;
  $[49] !== t10 || $[50] !== t11 || $[51] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsxs(PointerEvents.PointerEvents, { children: [
    t10,
    t11,
    t13
  ...
  let t16;
  return $[56] !== t14 || $[57] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    t14,
    t15
  ...
  } = props, ref = react.useRef(null), scrolledIntoViewRef = react.useRef(!1), t0 = `${rect.w}px`, t1 = `${rect.h}px`, t2 = `translate(${rect.x}px, ${rect.y}px)`;
  let t3;
  $[0] !== t0 || $[1] !== t1 || $[2] !== t2 ? (t3 = {
    width: t0,
    height: t1,
  ...
  }, t5 = [focused, wasMaybeCollapsed, enableScrollIntoView], $[4] = enableScrollIntoView, $[5] = focused, $[6] = wasMaybeCollapsed, $[7] = t4, $[8] = t5) : (t4 = $[7], t5 = $[8]), react.useEffect(t4, t5);
  ...
  let t7;
  $[11] !== hovered || $[12] !== isNearTop ? (t7 = [hovered, isNearTop], $[11] = hovered, $[12] = isNearTop, $[13] = t7) : t7 = $[13], react.useEffect(t6, t7);
  ...
  let t9;
  $[15] === Symbol.for("react.memo_cache_sentinel") ? (t9 = (plugin, context2) => {
    setActiveExclusivePlugin({
      plugin,
      context: context2
    });
  }, $[15] = t9) : t9 = $[15];
  const onActivateExclusivePlugin = t9, handleExclusivePluginClick = _temp5$1, ExclusivePluginComponent = activeExclusivePlugin?.plugin.component, [menuOpen, setMenuOpen] = react.useState(!1);
  let t10;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t10 = () => {
    react.startTransition(() => setMenuOpen(!1));
  }, $[16] = t10) : t10 = $[16];
  let t11;
  $[17] !== hovered ? (t11 = [hovered], $[17] = hovered, $[18] = t11) : t11 = $[18], react.useEffect(t10, t11);
  let t12;
  $[19] !== ExclusivePluginComponent || $[20] !== menuOpen ? (t12 = menuOpen || ExclusivePluginComponent ? /* @__PURE__ */ jsxRuntime.jsx(PointerEvents.PopoverBackground, { onDismiss: closeExclusivePluginView, blockScroll: menuOpen }) : null, $[19] = ExclusivePluginComponent, $[20] = menuOpen, $[21] = t12) : t12 = $[21];
  const t13 = focused ? "" : void 0, t14 = hovered ? "" : void 0, t15 = isNearTop ? "" : void 0, t16 = draggable ? "" : void 0, t17 = menuOpen ? "" : void 0;
  let t18;
  $[22] !== ExclusivePluginComponent || $[23] !== activeExclusivePlugin || $[24] !== hovered || $[25] !== props ? (t18 = ExclusivePluginComponent ? /* @__PURE__ */ jsxRuntime.jsx(ExclusivePluginContainer, { "data-sanity-overlay-element": !0, onClick: handleExclusivePluginClick, children: /* @__PURE__ */ jsxRuntime.jsx(ExclusivePluginComponent, { ...activeExclusivePlugin.context, closeExclusiveView: closeExclusivePluginView }) }) : hovered ? /* @__PURE__ */ jsxRuntime.jsx(ElementOverlayInner, { ...props, onActivateExclusivePlugin, onMenuOpenChange: setMenuOpen }) : null, $[22] = ExclusivePluginComponent, $[23] = activeExclusivePlugin, $[24] = hovered, $[25] = props, $[26] = t18) : t18 = $[26];
  let t19;
  $[27] !== style || $[28] !== t13 || $[29] !== t14 || $[30] !== t15 || $[31] !== t16 || $[32] !== t17 || $[33] !== t18 ? (t19 = /* @__PURE__ */ jsxRuntime.jsx(Root$3, { "data-focused": t13, "data-hovered": t14, "data-flipped": t15, "data-draggable": t16, "data-menu-open": t17, ref, style, children: t18 }), $[27] = style, $[28] = t13, $[29] = t14, $[30] = t15, $[31] = t16, $[32] = t17, $[33] = t18, $[34] = t19) : t19 = $[34];
  let t20;
  return $[35] !== t12 || $[36] !== t19 ? (t20 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    t12,
    t19
...
const Link = react.memo(function(props) {
  ...
  const href = t0;
  let t1;
  $[3] === Symbol.for("react.memo_cache_sentinel") ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(ActionOpen, { padding: 2, children: /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Text, { size: 1, weight: "medium", children: "Open in Studio" }) }), $[3] = t1) : t1 = $[3];
  let t2;
  return $[4] !== href ? (t2 = /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Box, { as: "a", href, target: "_blank", rel: "noopener noreferrer", children: t1 }), $[4] = href, $[5] = t2) : t2 = $[5], t2;
});
...
const PreviewSnapshotsProvider = function(props) {
  ...
  const context2 = previewSnapshots;
  let t6;
  return $[10] !== children || $[11] !== context2 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(PreviewSnapshotsContext.Provider, { value: context2, children }), $[10] = children, $[11] = context2, $[12] = t6) : t6 = $[12], t6;
};
...
const SchemaProvider = function(props) {
  ...
  const context2 = t10;
  let t11;
  return $[19] !== children || $[20] !== context2 ? (t11 = /* @__PURE__ */ jsxRuntime.jsx(SchemaContext.Provider, { value: context2, children }), $[19] = children, $[20] = context2, $[21] = t11) : t11 = $[21], t11;
};
...
const createStore = (initialState) => {
  ...
  const value_0 = t4;
  let t5;
  return $[8] !== children || $[9] !== value_0 ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(SharedStateContext.SharedStateContext.Provider, { value: value_0, children }), $[8] = children, $[9] = value_0, $[10] = t5) : t5 = $[10], t5;
};
...
const DocumentReporter = (props) => {
  ...
  let t1, t2;
  $[1] !== documentIds ? (t1 = () => {
    react.startTransition(() => setUniqueIds((prev) => {
...
function Overlays(props) {
  ...
  $[8] !== overlayEnabled ? (t7 = () => {
    ...
    fadeOutTimeoutRef.current && (clearTimeout(fadeOutTimeoutRef.current), react.startTransition(() => {
  ...
  const closeContextMenu = t10, optimisticActorReady = mutations.useOptimisticActorReady(), componentResolver = optimisticActorReady ? _componentResolver : void 0, [shouldHideActions, setShouldHideActions] = react.useState(!1);
  ...
  bb0: {
    ...
    let t122;
    $[15] !== comlink2 || $[16] !== componentResolver || $[17] !== dragMinimapTransition || $[18] !== dragShowMinimap || $[19] !== elements || $[20] !== isDragging || $[21] !== optimisticActorReady || $[22] !== props.plugins || $[23] !== shouldHideActions || $[24] !== wasMaybeCollapsed ? (t122 = elements.filter(_temp0).map((t132) => {
      const {
        id,
        element: element_0,
        focused,
        ...
        targets,
        elementType
      } = t132, draggable = !dragDisabled && !!element_0.getAttribute("data-sanity") && optimisticActorReady && elements.some((e_2) => "id" in e_2.sanity && "id" in sanity ? SharedStateContext.sanityNodesExistInSameArray(e_2.sanity, sanity) && e_2.sanity.path !== sanity.path : !1);
    ...
    }), $[15] = comlink2, $[16] = componentResolver, $[17] = dragMinimapTransition, $[18] = dragShowMinimap, $[19] = elements, $[20] = isDragging, $[21] = optimisticActorReady, $[22] = props.plugins, $[23] = shouldHideActions, $[24] = wasMaybeCollapsed, $[25] = t122) : t122 = $[25], t11 = t122;
  }
  const elementsToRender = t11, t12 = prefersDark ? "dark" : "light", t13 = fadingOut ? "" : void 0, t14 = overlaysFlash ? "" : void 0;
  let t15;
  $[26] !== documentIds || $[27] !== perspective ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(DocumentReporter, { documentIds, perspective }), $[26] = documentIds, $[27] = perspective, $[28] = t15) : t15 = $[28];
  let t16;
  $[29] !== comlink2 || $[30] !== inFrame || $[31] !== inPopUp || $[32] !== overlayEnabled || $[33] !== rootElement || $[34] !== updateDragPreviewCustomProps ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(OverlaysController, { comlink: comlink2, dispatch, inFrame, inPopUp, onDrag: updateDragPreviewCustomProps, overlayEnabled, rootElement }), $[29] = comlink2, $[30] = inFrame, $[31] = inPopUp, $[32] = overlayEnabled, $[33] = rootElement, $[34] = updateDragPreviewCustomProps, $[35] = t16) : t16 = $[35];
  let t17;
  $[36] !== contextMenu ? (t17 = contextMenu && /* @__PURE__ */ jsxRuntime.jsx(ContextMenu, { ...contextMenu, onDismiss: closeContextMenu }), $[36] = contextMenu, $[37] = t17) : t17 = $[37];
  let t18;
  $[38] !== dragGroupRect || $[39] !== dragInsertPosition || $[40] !== dragMinimapTransition || $[41] !== dragShowMinimapPrompt || $[42] !== isDragging ? (t18 = isDragging && !dragMinimapTransition && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
  ...
  let t19;
  $[44] !== dragSkeleton || $[45] !== isDragging ? (t19 = isDragging && dragSkeleton && /* @__PURE__ */ jsxRuntime.jsx(OverlayDragPreview, { skeleton: dragSkeleton }), $[44] = dragSkeleton, $[45] = isDragging, $[46] = t19) : t19 = $[46];
  let t20;
  $[47] !== elementsToRender || $[48] !== t13 || $[49] !== t14 || $[50] !== t15 || $[51] !== t16 || $[52] !== t17 || $[53] !== t18 || $[54] !== t19 || $[55] !== zIndex ? (t20 = /* @__PURE__ */ jsxRuntime.jsxs(Root, { "data-fading-out": t13, "data-overlays": t14, ref: setRootElement, $zIndex: zIndex, children: [
    t15,
    t16,
    t17,
    elementsToRender,
  ...
  let t21;
  $[57] !== comlink2 || $[58] !== t20 ? (t21 = /* @__PURE__ */ jsxRuntime.jsx(SharedStateProvider, { comlink: comlink2, children: t20 }), $[57] = comlink2, $[58] = t20, $[59] = t21) : t21 = $[59];
  let t22;
  $[60] !== comlink2 || $[61] !== t21 ? (t22 = /* @__PURE__ */ jsxRuntime.jsx(PreviewSnapshotsProvider, { comlink: comlink2, children: t21 }), $[60] = comlink2, $[61] = t21, $[62] = t22) : t22 = $[62];
  let t23;
  $[63] !== comlink2 || $[64] !== elements || $[65] !== t22 ? (t23 = /* @__PURE__ */ jsxRuntime.jsx(SchemaProvider, { comlink: comlink2, elements, children: t22 }), $[63] = comlink2, $[64] = elements, $[65] = t22, $[66] = t23) : t23 = $[66];
  let t24;
  $[67] !== rootElement || $[68] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.LayerProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.PortalProvider, { element: rootElement, children: t23 }) }), $[67] = rootElement, $[68] = t23, $[69] = t24) : t24 = $[69];
  let t25;
  $[70] !== t12 || $[71] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.ThemeProvider, { scheme: t12, theme: _visualEditing.studioTheme, tone: "transparent", children: t24 }), $[70] = t12, $[71] = t24, $[72] = t25) : t25 = $[72];
  let t26;
  return $[73] !== comlink2 || $[74] !== t25 ? (t26 = /* @__PURE__ */ jsxRuntime.jsx(TelemetryProvider, { comlink: comlink2, children: t25 }), $[73] = comlink2, $[74] = t25, $[75] = t26) : t26 = $[75], t26;
}
function _temp0(e_1) {
...
function useComlink(t0) {
  ...
  $[0] !== active ? (t1 = () => {
    ...
    react.startTransition(() => setNode(instance));
    const stop = instance.start();
    return () => {
      unsub(), stop(), react.startTransition(() => setNode(void 0));
    };
...
const VisualEditing = (props) => {
  ...
  $[2] !== portal ? (t3 = () => {
    ...
    return document.documentElement.appendChild(node), react.startTransition(() => setPortalElement(node)), () => {
      react.startTransition(() => setPortalElement(null)), document.documentElement.contains(node) && document.documentElement.removeChild(node);
    };

  ...
  return (
    <div className="w-full">
      <ScrollStack useWindowScroll={true}>
        ...
        <ScrollStackItem itemClassName="bg-gradient-to-br from-purple-100 to-purple-200">
          <h2 className="text-3xl font-bold mb-4">Card 4</h2>
          <p className="text-lg">This is the fourth card in the stack</p>
        </ScrollStackItem>
        <ScrollStackItem itemClassName="bg-gradient-to-br from-orange-100 to-orange-200">
          <h2 className="text-3xl font-bold mb-4">Card 5</h2>
          <p className="text-lg">This is the fifth card in the stack</p>
        </ScrollStackItem>
      </ScrollStack>
    </div>
  )
